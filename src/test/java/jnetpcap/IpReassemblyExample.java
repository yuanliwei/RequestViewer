...
public class IpReassemblyExample implements PcapPacketHandler<Object> {
	...
	public static void main(String[] args) {
		...
		// String
		// pp="D:\\devtool\\workspace_eclipse-jee-mars-2-win32-x86_64\\requestviewer\\src\\test\\resources\\tests\\test-ipreassembly2.pcap";
		// Pcap pcap =
		// Pcap.openOffline(pp, errbuf);
		// if (pcap == null) {
		 ...
		 */
		Http http = new Http();
		pcap.loop(-1, new IpReassemblyExample(5 * 1000, new IpReassemblyBufferHandler() {
...
//					 System.out.println(packet.toString());
					if (packet.hasHeader(http)) {
						String string = http.getUTF8String(0, http.getLength());
						System.out.println(string);
						System.out.println(new String(http.getPayload()));
						System.out.println("contentLength : "+ http.getPayloadLength());
//						System.out.println(packet.getUTF8String(http.pa, packet.size()));
					}else {
						System.out.println(packet.toString());
					}
					
//					 System.out.println(packet.hasHeader(header));
//					System.out.println(packet.getUTF8String(0, packet.size()));
				}
