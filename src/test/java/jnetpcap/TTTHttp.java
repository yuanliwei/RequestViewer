			...
			public void nextPacket(PcapPacket packet, String user) {
				...
				if (packet.hasHeader(ip4)) {
					if (packet.hasHeader(tcp)) {
						System.out.println("======================================");
						String un = tcp.source() + "|" + tcp.destination() + "|" + ip4.sourceToInt() + "|"
								+ ip4.destinationToInt();
						System.out.println("UN:" + un + "  seq:" + tcp.seq() + "  pSize:"
								+ tcp.getPayloadLength() + " ack:" + tcp.ack() + " flag:" + tcp.flagsCompactString());
						...
						if (packet.hasHeader(http)) {
							...
							// String s2;
							// s2 = new
							// String(com.ylw.common.utils.ZipUtil.gunzip(http.getPayload()));
							// System.out.println(s2);
							// } catch (Exception e) {
							//// e.printStackTrace();
							String s2;
							s2 = new String(http.getPayload());
							// System.out.println(s2);
							// }
							...
							// System.out.println(tcp.seq());
							String s3 = new String(tcp.getPayload());
